...
local SAKURA_DARK = Color3.fromRGB(199, 21, 133)   -- deep sakura (đậm)
local SAKURA_LIGHT = Color3.fromRGB(255, 154, 200)  -- soft sakura (nhạt)
local SAKURA_BRIGHT = Color3.fromRGB(255, 90, 165)  -- bright glowing sakura for stroke/borders

local BASE_W, BASE_H = 360, 430
...
function Library:CreateWindow(config)
    ...
    local Topbar = New("Frame", {
        Name = "Topbar",
        BackgroundColor3 = Color3.fromRGB(255, 200, 214),
    ...
    local Title = New("TextLabel", {
        ...
        TextColor3 = Color3.fromRGB(199, 21, 133),
    ...
    local MinBtn = New("ImageButton", {
        Name = "MinBtn",
        BackgroundColor3 = Color3.fromRGB(255, 195, 212),
    ...
    -- Animated (GIF-style) open/close icon: cycles through frames while the UI exists
    local MinBtnFrames = {
        "rbxassetid://127414290041747",
        "rbxassetid://136711667108187",
        "rbxassetid://96963815540287",
        "rbxassetid://101917739837005",
        "rbxassetid://74250411603598",
    }
    task.spawn(function()
        while ScreenGui.Parent do
            for _, id in ipairs(MinBtnFrames) do
...
function Window:Tab(config)
        ...
        local TabIcon = New("ImageLabel", {
            ...
            BackgroundTransparency = 1,
            Image = imageId,
            ImageColor3 = Color3.fromRGB(224, 160, 185),
        }, TabBtn)
        ...
        local TabText = New("TextLabel", {
            ...
            TextColor3 = Color3.fromRGB(224, 160, 185),
            Font = Enum.Font.GothamBold,
            TextSize = s(11),
            BackgroundTransparency = 1,
            TextXAlignment = Enum.TextXAlignment.Left,
        ...
        local function UpdateTabVisuals(selected)
            local accent = selected and Color3.fromRGB(255, 154, 200) or Color3.fromRGB(224, 160, 185)
            local bg = selected and Color3.fromRGB(255, 210, 222) or Color3.fromRGB(255, 225, 235)
        ...
        function Tab:CreateModule(mConfig)
            ...
            local ModuleFrame = New("Frame", {
                BackgroundColor3 = Color3.fromRGB(255, 214, 224),
            ...
            local titleWidth = hasKeybind and s(115) or s(150)
            ...
            if hasKeybind then
                KeybindBtn = New("TextButton", {
                    ...
                    BackgroundColor3 = Color3.fromRGB(255, 205, 220),
                    AutoButtonColor = false,
            ...
            local ToggleDot = New("Frame", {
                ...
                BackgroundColor3 = Color3.fromRGB(235, 190, 205),
            }, ToggleBg)
            ...
            local function recalc(animate)
                ...
                if animate then
                    Tween(ModuleFrame, {Size = UDim2.new(MODULE_W, 0, 0, target)}, 0.3)
                else
            ...
            local function setEnabled(state, fromUser)
                ...
                Tween(ToggleDot, {
                    ...
                    BackgroundColor3 = state and Color3.fromRGB(255, 154, 200) or Color3.fromRGB(235, 190, 205),
                }, 0.2)
                recalc(true)
                if fromUser then
...
function Library.ModuleMeta:CreateButton(config)
    ...
    Round(Btn, s(6))
    Stroke(Btn, 1, 0.6)
    Btn.MouseEnter:Connect(function() Tween(Btn, {BackgroundColor3 = Color3.fromRGB(255, 190, 208)}, 0.15) end)
    Btn.MouseLeave:Connect(function() Tween(Btn, {BackgroundColor3 = Color3.fromRGB(255, 205, 220)}, 0.15) end)
...
function Library.ModuleMeta:CreateToggle(config)
    ...
    local Bg = New("Frame", {
        ...
        BackgroundColor3 = state and Color3.fromRGB(255, 154, 200) or Color3.fromRGB(255, 180, 200),
    }, Row)
    Round(Bg, s(999))
    local Dot = New("Frame", {
    ...
    Click.MouseButton1Click:Connect(function()
        state = not state
        Tween(Bg, {BackgroundColor3 = state and Color3.fromRGB(255, 154, 200) or Color3.fromRGB(255, 180, 200)}, 0.15)
