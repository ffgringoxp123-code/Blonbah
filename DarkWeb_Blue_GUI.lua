...
Window = Fluent:CreateWindow({
    Title = "DarkWeb.Blue",
    SubTitle="by DarkWeb.Blue", 
    TabWidth=155, 
    Theme="Darker" -- Black/Blue theme,
    Acrylic=false,
...
Button.Image = "rbxassetid://129861447099059"
...
Tabs.Info:AddButton({
    ...
    Description="Youtube",
    Callback=function()
        setclipboard(tostring("https://www.youtube.com/feed/library"))
    end
})
Tabs.Info:AddButton({
    Title="thịnh",
